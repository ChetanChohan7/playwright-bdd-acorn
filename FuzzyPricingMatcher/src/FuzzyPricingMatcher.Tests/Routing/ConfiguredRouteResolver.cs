...
public sealed class ConfiguredRouteResolver : ILoaderRouteResolver, IScenarioRouteResolver
{
    private readonly MatcherConfiguration configuration;
    private readonly IntegrationConfigurationValidator validator;

    public ConfiguredRouteResolver(MatcherConfiguration configuration, IntegrationConfigurationValidator validator)
    {
